...
public final class ItemUtils {
    ...
    public static boolean isSword(@NotNull ItemStack item) {
        ...
        NBTCompound swordData = NBTItem.convertItemtoNBT(item);
        String swordString = swordData.toString();

        if (swordString.contains("sword") || swordString.contains("Sword")) {
            return true;
        }
        else if(mcMMO.getMaterialMapStore().isSword(item.getType().getKey().getKey()) == true){
            return true;
        }
        else{
            return false;
    ...
    public static boolean isHoe(@NotNull ItemStack item) {
        ...
        NBTCompound hoeData = NBTItem.convertItemtoNBT(item);
        String hoeString = hoeData.toString();

        if (hoeString.contains("hoe") || hoeString.contains("Hoe")) {
            return true;
        }
        else if(mcMMO.getMaterialMapStore().isHoe(item.getType().getKey().getKey()) == true){
            return true;
        }
        else{
            return false;
    ...
    public static boolean isShovel(@NotNull ItemStack item) {
        ...
        NBTCompound shovelData = NBTItem.convertItemtoNBT(item);
        String shovelString = shovelData.toString();

        if (shovelString.contains("shovel") || shovelString.contains("Shovel")) {
            return true;
        }
        else if(mcMMO.getMaterialMapStore().isShovel(item.getType().getKey().getKey()) == true){
            return true;
        }
        else{
            return false;
    ...
    public static boolean isAxe(@NotNull ItemStack item) {
        ...
        NBTCompound axeData = NBTItem.convertItemtoNBT(item);
        String axeString = axeData.toString();

        if (axeString.contains("axe") || axeString.contains("Axe")) {
            return true;
        }
        else if(mcMMO.getMaterialMapStore().isAxe(item.getType().getKey().getKey()) == true){
            return true;
        }
        else{
            return false;
    ...
    public static boolean isPickaxe(@NotNull ItemStack item) {
        ...
        NBTCompound pickaxeData = NBTItem.convertItemtoNBT(item);
        String pickaxeString = pickaxeData.toString();

        if (pickaxeString.contains("pick") || pickaxeString.contains("Pick")) {
            return true;
        }
        else if(mcMMO.getMaterialMapStore().isPickAxe(item.getType().getKey().getKey()) == true){
            return true;
        }
        else{
            return false;
